        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold bg-gradient-to-r from-[#014446] to-[#44BC95] bg-clip-text text-transparent">Leanifi Admin</h1>
                <p className="text-xs text-gray-500 font-medium">eMAR Management System</p>
              </div>
            </div>
